...
6. 发版您的版本
    ...
    git tag v2.14.0-beta.8
    git push origin v2.14.0-beta.8
    ...
    git -c http.sslVerify=false push origin v2.11.7-beta.1
    # 删除配置项
